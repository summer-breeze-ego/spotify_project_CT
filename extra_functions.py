...
def names() -> List[str]:
    ...
    try:
        # opening file
        file = open("/Users/augustincoman/Library/CloudStorage/OneDrive-Personal/University/NL Courses/YEAR 1/Period 2/Computational Thinking/CT_PROJECT_64/spotify_project_CT_CODE/data/names.txt", 'r')
